...
//
//        for i in 0 ... 8 {
//            Device.shared.passwordArray = [packet![i + 7], 0xff]
//        }
//
//        Device.shared.SA_PASS1_1_2 = ((packet[7], 0xff) << 8) | (packet[8]  & 0xff);
//        Device.shared.SA_PASS1_3_4 = ((packet[9], 0xff) << 8) | (packet[10] & 0xff);
//        Device.shared.SA_PASS1_5_6 = ((packet[11], 0xff) << 8) | (packet[12] & 0xff);
//        Device.shared.SA_PASS1_7_8 = ([packet[13], 0xff] << 8) | (packet[14] & 0xff)
//
//        for i in 0 ... 256 {
//            packet[i] = 0
//        }
...
//
//    //********************************************************************************************************************
//    //send password ja esta implementado
//
//}
//
//
